...
public class Destinations extends JFrame implements Runnable {
    ...
    public void run()
    {
        String[] text=new String[]{"The Taj Hotel","JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classsio Hotel","The Bay Club Hotel","Hotel Ambience","The Royal Hotel","The Palace"};
        try{
            for(int i=0;i<9;i++)
            {
